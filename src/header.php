        ...
        <div class="container">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="index.php" class="nav-link px-2 text-white"><i class="fas fa-home"></i>Trang chủ</a></li>
                ...
                <div class="text-end">
                    <a href=""><button type="button" class="btn btn-outline-light ">Tài Khoản</button></a>
                </div>
            </div>
        </div>
    </header>